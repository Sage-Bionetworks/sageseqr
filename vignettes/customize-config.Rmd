...
cpm threshold: The minium allowable CPM to keep a gene in the analysis.
percent threshold: The percentage of samples that should contain the minimum number
