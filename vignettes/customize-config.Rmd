...
```
analysis title:   Required. The name of your project. This will become the name 
                  of your output html file.
counts:
...
dimensions:       Required. Specify the PCA dimensions by variable name. 
  ...
  shape:
  size:
skip model:       Optional. If TRUE, the exploratory data report is run. Model selection and
                  is not computed.
